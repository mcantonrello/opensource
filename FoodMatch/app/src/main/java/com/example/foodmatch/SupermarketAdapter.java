...
public class SupermarketAdapter extends ArrayAdapter<GroceryItem> {

    private Context context;
    private int resource;
    private ArrayList<GroceryItem> groceryList;
    private SupermarketActivity activity; // Referencia a la actividad para manejar la eliminación


    public SupermarketAdapter(Context context, int resource, ArrayList<GroceryItem> groceryList, SupermarketActivity activity) {
